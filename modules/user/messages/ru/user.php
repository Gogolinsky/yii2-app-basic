...
return [
    ...
    'A password will be generated automatically if not provided' => 'Если вы хотите, чтобы пароль был сгенерирован автоматически, оставьте поле пустым',
    'Account' => 'Аккаунт',
    ...
    'You can now log in with the following credentials:' => 'Вы можете использовать его вместе с вашим email для входа',
